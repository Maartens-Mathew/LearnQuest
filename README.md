...
This project was a journey of discovery for our team. We dove deep into Android development, mastering new skills in a short timeframe and growing from novice app developers to collaborative problem solvers.
...
- ⚡️ **Supabase-powered backend** — Fast, reliable, and scalable backend for data storage and retrieval. Includes custom Remote Procedure Calls for seamless many-to-many operations.
...
- **Platform:** Android
- **Language:** Java ☕️
- **Database:** Supabase (relational core, custom RPCs for complex queries) 🗂️
...
- 🏗️ Multi-module project structure for robust separation of concerns
...
- 🧠 Take advantage of Kotlin's functional programming style, and use sealed classes for UI-state control
- 🏛️ Adopt the Repository Pattern, where implementations are wrapped in interfaces to ease testing and swapping out implementations
...
1. **Clone the repository:**
   ...
   ```
2. **Requirements:**
   - Android Studio (latest, with Java 8+ support) 🖥️
...
- Developed as a collaborative third-year Capstone project. A big thank you to Narsi Nisha and Granville Daniels, for their committed work to the project.
- Special thanks to Supabase for simplifying database ops under university network constraints.
- Deep appreciation for the open-source ecosystem that made this learning possible.
