...
public class editQuizFromValidAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchInContention.setVisibility(View.GONE); // To make it invisible
        ...
        tagsCall.enqueue(new Callback<List<Tag>>() {
            ...
            public void onResponse(Call<List<Tag>> call, Response<List<Tag>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(editQuizFromValidAct.this, "Failed to load tags", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<Tag>> call, Throwable t) {
                ...
                Toast.makeText(editQuizFromValidAct.this, "Error loading tags", Toast.LENGTH_SHORT).show();
            }
        });
    }
